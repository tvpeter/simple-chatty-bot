...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        if(grid[2][0].equals(grid[1][1]).equals(grid[0][2])):
            return grid[2][0]+ " wins";

        if(grid[0][0].equals(grid[1][1]).equals(grid[2][2]) || grid[0][0].equals(grid[0][1]).equals(grid[0][2])){

            return grid[0][0] + "wins";

        }

        if(grid[1][0].equals(grid[1][1]).equals(grid[1][2])):
            return grid[1][0]+ " wins";

        if(grid[2][0].equals(grid[2][1]).equals(grid[2][2])):
            return grid[1][0] + " wins";

        if(grid[0][0].equals(grid[1][0]).equals(grid[2][0])):
            return grid[0][0] + " wins";

        if(grid[0][1].equals(grid[1][1]).equals(grid[2][1])):
            return grid[0][1] + " wins";

        if(grid[0][2].equals(grid[1][2]).equals(grid[2][2])):
            return grid[0][1] + " wins";
